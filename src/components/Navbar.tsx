...
const Navbar = () => {
  ...
  useEffect(() => {
    const mediaQuery = window.matchMedia('(max-width: 1024px)'); // Ändra till 1024px
  ...
  return (
    <nav className={`fixed inset-x-0 bottom-0 lg:absolute lg:top-0 bg-white lg:bg-transparent p-2 lg:p-5 z-50 transition-transform duration-300 ${show ? 'translate-y-0' : 'translate-y-full lg:translate-y-0'}`}>
      <div className="flex justify-around lg:justify-between lg:w-auto mx-auto lg:mx-0 lg:pr-100">
        <NavLink
          to="/"
          className={({ isActive }) =>
            `flex flex-col items-center lg:flex-row ${isActive ? 'border-t-4 lg:border-t-0 lg:border-b-2 border-wild-blue-yonder lg:border-almond p-1 lg:rounded-none' : ''}`
          }
        >
          <img src={homeIcon} alt="Home" className="h-6 w-6 lg:hidden" />
          <span className="block text-xs lg:text-sm text-gray-web lg:text-baby-powder">Home</span>
        </NavLink>
        <NavLink
          to="/puppies"
          className={({ isActive }) =>
        ...
        >
          <img src={puppiesIcon} alt="Puppies" className="h-6 w-6 lg:hidden" />
          <span className="block text-xs lg:text-sm text-gray-web lg:text-baby-powder">Puppies</span>
        </NavLink>
        <NavLink
          to="/dogs"
          className={({ isActive }) =>
        ...
        >
          <img src={dogsIcon} alt="Dogs" className="h-6 w-6 lg:hidden" />
          <span className="block text-xs lg:text-sm text-gray-web lg:text-baby-powder">Dogs</span>
        </NavLink>
        <NavLink
          to="/posts"
          className={({ isActive }) =>
        ...
        >
          <img src={postsIcon} alt="Posts" className="h-6 w-6 lg:hidden" />
          <span className="block text-xs lg:text-sm text-gray-web lg:text-baby-powder">Posts</span>
        </NavLink>
        <NavLink
          to="/contact"
          className={({ isActive }) =>
        ...
        >
          <img src={contactIcon} alt="Contact" className="h-6 w-6 lg:hidden" />
          <span className="block text-xs lg:text-sm text-gray-web lg:text-baby-powder">Contact</span>
        </NavLink>
      </div>
    </nav>
  );
...
// navbar i botten for mobile up till 768px wide
