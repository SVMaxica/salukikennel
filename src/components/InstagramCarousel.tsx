...
const InstagramCarousel: React.FC = () => {
  ...
  //const [posts] = useState<Post[]>([...instagramData.posts, ...instagramData.posts]);
  // Duplicating posts
...
const PostCard: React.FC<PostCardProps> = ({ post, username }) => {
  ...
  return (
    <div className="bg-white rounded-lg shadow-lg overflow-hidden p-4 h-auto max-w-sm mx-auto">
